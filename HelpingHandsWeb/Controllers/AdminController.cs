...
namespace HelpingHandsWeb.Controllers
{
    ...
    public class AdminController: Controller
    {
        ...
        public IActionResult Cities()
            {
                var cities = _context.Cities.Where(c => !c.IsDeleted).Select(c => new CityViewModel
                {
                    CityId = c.CityId,
                        Name = c.Name,
        ...
        public IActionResult EditCity(int id)
            {
                var city = _context.Cities.Where(c => c.CityId == id && !c.IsDeleted).Select(c => new CityViewModel
                {
                    CityId = c.CityId,
                        Name = c.Name,
                        Abbreviation = c.Abbreviation
        ...
        public IActionResult EditCity(CityViewModel model)
            {
                ...
                {
                    var city = _context.Cities.Where(c => c.CityId == model.CityId && !c.IsDeleted).FirstOrDefault();
                    if (city != null)
                    {
        ...
        public IActionResult DeleteCity(int id)
            {
                var city = _context.Cities.Where(c => c.CityId == id && !c.IsDeleted).FirstOrDefault();
                if (city != null)
                {
                    city.IsDeleted = true;
                    _context.SaveChanges();
        ...
        public IActionResult Suburbs()
            {
                var suburbs = _context.Suburbs.Where(s => !s.IsDeleted).Select(s => new SuburbViewModel
                {
                    SuburbID = s.SuburbID,
        ...
        public IActionResult EditSuburb(int id)
            {
                var suburb = _context.Suburbs.Where(s => s.SuburbID == id && !s.IsDeleted).Select(s => new SuburbViewModel
                {
                    SuburbID = s.SuburbID,
                        SuburbName = s.SuburbName,
                        PostalCode = s.PostalCode,
        ...
        public IActionResult EditSuburb(SuburbViewModel model)
            {
                if (ModelState.IsValid)
                {
                    var suburb = _context.Suburbs.Where(s => s.SuburbID == model.SuburbID && !s.IsDeleted).FirstOrDefault();
                    if (suburb != null)
                    {
        ...
        public IActionResult DeleteSuburb(int id)
            {
                var suburb = _context.Suburbs.Where(s => s.SuburbID == id && !s.IsDeleted).FirstOrDefault();
                if (suburb != null)
                {
        ...
        public IActionResult Conditions()
            {
                var conditions = _context.ChronicConditions.Where(c => !c.IsDeleted).Select(c => new ConditionViewModel
                {
        ...
        public IActionResult EditCondition(int id)
            {
                var condition = _context.ChronicConditions.Where(c => c.ConditionID == id && !c.IsDeleted).Select(c => new ConditionViewModel
                {
                    ConditionID = c.ConditionID,
                        Name = c.Name,
                        Description = c.Description
        ...
        public IActionResult EditCondition(ConditionViewModel model)
            {
                if (ModelState.IsValid)
                {
                    var condition = _context.ChronicConditions.Where(c => c.ConditionID == model.ConditionID && !c.IsDeleted).FirstOrDefault();
                    if (condition != null)
                    {
        ...
        public IActionResult DeleteCondition(int id)
            {
                var condition = _context.ChronicConditions.Where(c => c.ConditionID == id && !c.IsDeleted).FirstOrDefault();
                if (condition != null)
                {
